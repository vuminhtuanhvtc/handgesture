...
interpreter = tf.lite.Interpreter(model_path='data/keypoint_classifier.tflite', num_threads=1)
interpreter.allocate_tensors()
input_details = interpreter.get_input_details()
output_details = interpreter.get_output_details()

with open('data/keypoint_classifier_label.csv',
...
#    image = cv.flip(image, 1)
    ...
    detected_gesture = ""
    hand_rect = None
    landmark_points = None  # Add this line
    ...
    if results.multi_hand_landmarks is not None:
        for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
            ...
            if area > config.config['gesture']['handsize']:
                ...
                landmark_points = landmark_list  # Add this line
    ...
    # Return the detected gesture, bounding box information, and landmarks
    return detected_gesture, hand_rect, landmark_points  # Modified return
